...
Messaging = (function (global) {
    ...
    //MQTT protocol and version        6    M    Q     T     T     4
    var MqttProtoIdentifier = [0x00, 0x04, 0x4d, 0x51, 0x54, 0x54, 0x04];
...
//    	    	break;
    ...
    ClientImpl.prototype._doConnect = function (host, port) {
        ...
        if (this.connectOptions.useSSL)
            wsurl = ["wss://", host, ":", port, "/$iothub/websocket"].join("");
        else
            wsurl = ["ws://", host, ":", port, "/$iothub/websocket"].join("");
